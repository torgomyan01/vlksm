...
function QuickView() {
  ...
  return (
    <Modal isOpen={modal} onClose={openQuickView} size="2xl" placement="top">
      <ModalContent>
        <div className="container pt-[50px]">
          ...
          <div className="w-full h-full grid grid-cols-1 gap-[20px] px-5">
            <div className="sticky top-[20px] z-10 product-slider">
              <div className="w-full bg-blue/20 rounded-[6px] h-[400px]">
                <Slider
                  ref={sliderRef}
                  {...settings}
            ...
            <div>
              ...
              <h2 className="text-[21px] mt-[10px]">
                1000 ₽{" "}
                <span className="text-black/70 line-through">1990 ₽</span>{" "}
              ...
              <p className="text-[15px] text-black/70">
                Коммутатор для презентаций 5×1 4K60 поддерживает 5 входов,
                включая 3 порта HDMI, 1 порт VGA (YPbPr / CVBS) и 1 порт
                DisplayPort, с возможностью масштабирования до выходов HDMI и
                HDBaseT (зеркальный). Предлагает гибкое применение звука,
                которое включает в себя несимметричный звук, микрофонный вход и
                линейный выход. Аудиопроцессор предлагает автоматический микшер
                и управление автоматическим усилением для микширования или
                уменьшения фонового звука для улучшения основного источника
                звука. Системой можно легко управлять и настраивать через
                Telnet, WebGUI, ИК-пульт и RS-232.
              </p>
              <ul className="text-[15px] text-black/70 mt-4 list-disc pl-6">
                ...
                <li>
                  Поддержка автоматического и ручного переключения режимов
                </li>
